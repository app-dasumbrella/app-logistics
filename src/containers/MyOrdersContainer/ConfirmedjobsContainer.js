...
const mapStateToProps = (state, props) => {
  return {
    ...
    accpetedJobs: state.app.accpetedJobs,
...
export default class ConfirmedjobsContainer extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <NavBarLogo title='Assigned Jobs' />
        <ScrollView refreshControl={
          ...
          >
            <Text style={styles2.titleEmpty}>Please accept new jobs
            </Text>
          </View>}
